// bountyPoster.js (ose welcome.js)
const { createCanvas, loadImage, registerFont } = require("canvas");
const { AttachmentBuilder } = require("discord.js");
const fetch = require("node-fetch"); // Kjo rresht rregullon gabimin
...
async function createBountyPoster(member, bountyValue) {
  try {
    ...
    const response = await fetch(avatarURL); // Tani fetch duhet të funksionojë
